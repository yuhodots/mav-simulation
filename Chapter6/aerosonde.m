% There are some issues with the Zagi coefficients given in the book. 
% We recommend that you use the following (slightly modified from the book) coefficients for the aerosonde aircraft.
